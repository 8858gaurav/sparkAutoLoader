...
%sql
describe detail orderdeltanew3;
-- format	delta
-- id	8039e2a0-d103-40c8-9978-6ed9a58e6a33
-- name	workspace.default.orderdeltanew3
-- description	null
-- location	
-- createdAt	2025-12-26T06:42:56.886Z
-- lastModified	2025-12-26T06:43:01.766Z
-- partitionColumns	[]
-- clusteringColumns	[]
-- numFiles	1
-- sizeInBytes	1709
-- properties	{"delta.parquet.compression.codec":"zstd","delta.enableDeletionVectors":"true","delta.writePartitionColumnsToParquet":"true","delta.enableRowTracking":"true","delta.rowTracking.materializedRowCommitVersionColumnName":"_row-commit-version-col-f4903f58-beec-4fd8-be5f-0db0491608ab","delta.rowTracking.materializedRowIdColumnName":"_row-id-col-76e4caa8-418f-428c-b393-44f866c4d434"}
-- minReaderVersion	3
-- minWriterVersion	7
...
-- location	
-- createdAt	2025-12-26T06:42:56.886Z
-- lastModified	2025-12-26T06:45:15.957Z
-- partitionColumns	[]
-- clusteringColumns	[]
-- numFiles	2
-- sizeInBytes	3418
...
-- customer_id	order_date	order_id	order_status	_rescued_data
-- 11599	2013-07-25 00:00:00.0	5	CLOSED	"{""order_amount"":10,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file3.json""}"
-- 256	2013-07-25 00:00:00.0	6	PENDING_PAYMENT	"{""order_amount"":20,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file3.json""}"
-- 12111	2013-07-25 00:00:00.0	7	COMPLETE	"{""order_amount"":30,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file3.json""}"
-- 8827	2013-07-25 00:00:00.0	8	CLOSED	"{""order_amount"":40,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file3.json""}"
-- 11599	2013-07-25 00:00:00.0	1	CLOSED	null
-- 256	2013-07-25 00:00:00.0	2	PENDING_PAYMENT	null
-- 12111	2013-07-25 00:00:00.0	3	COMPLETE	null
-- 8827	2013-07-25 00:00:00.0	4	CLOSED	null
...
-- location	
-- createdAt	2025-12-26T06:42:56.886Z
-- lastModified	2025-12-26T06:46:35.297Z
-- partitionColumns	[]
-- clusteringColumns	[]
-- numFiles	3
-- sizeInBytes	5674
...
select * from orderdeltanew3;
-- customer_id	order_date	order_id	order_status	_rescued_data
-- null	2013-07-25 00:00:00.0	9	COMPLETE	"{""customer_id"":""COMPLETE"",""order_amount"":10,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file4.json""}"
-- 256	2013-07-25 00:00:00.0	10	PENDING_PAYMENT	"{""order_amount"":20,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file4.json""}"
-- 12111	2013-07-25 00:00:00.0	11	COMPLETE	"{""order_amount"":30,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file4.json""}"
-- 8827	2013-07-25 00:00:00.0	12	CLOSED	"{""order_amount"":40,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file4.json""}"
-- 11599	2013-07-25 00:00:00.0	5	CLOSED	"{""order_amount"":10,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file3.json""}"
-- 256	2013-07-25 00:00:00.0	6	PENDING_PAYMENT	"{""order_amount"":20,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file3.json""}"
-- 12111	2013-07-25 00:00:00.0	7	COMPLETE	"{""order_amount"":30,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file3.json""}"
-- 8827	2013-07-25 00:00:00.0	8	CLOSED	"{""order_amount"":40,""_file_path"":""/Volumes/workspace/default/my_volume/retail_data/orders_data/file3.json""}"
...
-- location	
-- createdAt	2025-12-26T06:42:56.886Z
-- lastModified	2025-12-26T06:48:03.389Z
-- partitionColumns	[]
-- clusteringColumns	[]
-- numFiles	4
-- sizeInBytes	8005
